...
rule bwa_run:
	input:
		...
		"/shared/liuhj/HP/process/assembly/all_genomes/{bwa_ref_samp}.fasta.bwt"
	output:
		temp("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/bwa/{sample}/{sample}_2_{bwa_ref_samp}.piloned.bam")
	shell:
...
rule bam_sort:
	input:
		"/shared/liuhj/HP/process/NGS_map2PersonResptGnm/bwa/{sample}/{sample}_2_{bwa_ref_samp}.piloned.bam"
	output:
