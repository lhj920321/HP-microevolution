...
rule mpileup:
	input:
		"/shared/liuhj/HP/process/assembly/all_genomes/{bwa_ref_samp}.fasta",
		"/shared/liuhj/HP/process/CCS_map2PersonRespectSamp/ngmlr/{sample}/{sample}_2_{bwa_ref_samp}_2_selfGnm.sort.bam",
		"/shared/liuhj/HP/process/assembly/all_genomes/{bwa_ref_samp}.fasta.fai",
		"/shared/liuhj/HP/process/CCS_map2PersonRespectSamp/ngmlr/{sample}/{sample}_2_{bwa_ref_samp}_2_selfGnm.sort.bam.bai"
	output:
