...
rule all:
	...
	#bwa map
		...
		##snpeff vcf
		#expand("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/vcf_snpeff",person=personLst),

		##general snvFreq_distribut_Stat
		#expand("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/general-snvFreq_distribut_Stat",person=personLst),
		## snvNum_Stat
		#expand("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/table/snvNum_Stat",person= personLst),
		## snv_density_distribution
		#expand("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/snv_density_Stat_1k",person= personLst),
		
		##all sa -----
		#expand("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/20210331-snvSNP_AnnoStat_OtherBacFilted_RepeatFilted",person=personLst),

		##SNP genome sub SNP posi
		#expand("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/subGnm",person=personLst),
		#expand("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/subGnm_prokka_gff",person=personLst),


		##SNV Freq distribut(Repeat Regions were filted)
		expand("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/SNVFreq_distribut_Stat_filtRepeat_0.2",person=personLst),
...
rule iSNV_freq_distribut:
	input:
		"/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/all.iSNV_with_SNP.pyResults.txt",
	output:
		outputP=directory("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/general-snvFreq_distribut_Stat")
	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
...
rule iSNV_freq_distribut_RepeatRegionfilt:
	...
	output:
		outputP=directory("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/SNVFreq_distribut_Stat_filtRepeat_0.2")
	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
		#iSNV_FreqThres = 0.05,     ## for examp: iSNV_FreqThres = 0.05, mean iSNV freq :>=0.05 && <0.95  ;SNP: >=0.95
		minFreq	= 0.2,
...
rule snpeffAnno:
	input:
		inputvcfP="/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/vcf"
	output:
		outputP=directory("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/vcf_snpeff")
	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
		dbID="AE004091",
...
rule iSNV_snvNumCount:
	...
	output:
		outputP=directory("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/snvNum_Stat")
	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
		#iSNV_FreqThres = 0.05,     ## for examp: iSNV_FreqThres = 0.05, mean iSNV freq :>=0.05 && <0.95  ;SNP: >=0.95
		minFreq	= 0.1,
...
rule iSNV_snv_density_Stat_1k:
	input:
		iSNVtable="/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/all.iSNV_with_SNP.pyResults.txt",
	output:
		outputP=directory("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/snv_density_Stat_1k"),
	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
		minFreq	= 0.02,
...
rule iSNV_snvNumCount_noSNV:
	input:
		...
		snpEffPath="/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/vcf_snpeff",
	...
	output:
		outputP=directory("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/table/snvNum_Stat")
	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
		#iSNV_FreqThres = 0.05,     ## for examp: iSNV_FreqThres = 0.05, mean iSNV freq :>=0.05 && <0.95  ;SNP: >=0.95
		minFreq	= 0.1,
...
rule iSNV_SNP_consensusGnm:
	...
	output:
		outputP=directory("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/subGnm")
	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
		MinFreq	= 0.9,
		#snv_MaxFreq	= 0.95,
...
rule consensusGnm_prokkaAnno:
	input:
		inputP="/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/subGnm"
	output:
		outputP=directory("/shared/liuhj/HP/process/NGS_map2PersonResptGnm/table/{person}/subGnm_prokka_gff")
	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
