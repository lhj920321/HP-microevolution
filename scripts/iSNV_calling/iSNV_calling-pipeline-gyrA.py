...
rule all:
	...
	#bwa map
		## iSNV calling
		expand("/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/all.iSNV_with_SNP.pyResults.txt",person=personLst),
		##vcf
		#expand("/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/vcf",person=personLst),
		##snpeff vcf
		#expand("/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/vcf_snpeff",person=personLst),

		##general snvFreq_distribut_Stat
		expand("/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/general-snvFreq_distribut_Stat",person=personLst),

		## snvNum_Stat
		#expand("/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/snvNum_Stat_noSNV_OtherBacfilted-FiltSimutPARepeat",person= personLst),

		##all sa
		#expand("/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/20210331-snvSNP_AnnoStat_OtherBacFilted_RepeatFilted",person=personLst),

		##SNP genome sub SNP posi
		#expand("/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/subGnm",person=personLst),
		#expand("/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/subGnm_prokka_gff",person=personLst),
...
rule ntfreq_2_FreqBigtable:
	input:
		configF="/shared/liuhj/HP/process/NGS_map2_gyrA/mpileup/{person}.all_ntfreq_files.txt",  ##format in the config file: path/sampID.ntfreq"\n"
		refF="/shared/liuhj/HP/ref/ref_resistanceGenes/gyrA.fasta",
	output:	
		outputF="/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/all.iSNV_with_SNP.pyResults.txt",
		outputF2="/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/out.samps-ntfreq.bigtable.txt",

	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
		outputP="/shared/liuhj/HP/process/NGS_map2_gyrA/{person}",
		DEP_THRES=50,       ##最低深度
...
rule iSNV_freq_distribut:
	input:
		"/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/all.iSNV_with_SNP.pyResults.txt",
	output:
		outputP=directory("/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/general-snvFreq_distribut_Stat")
	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
...
rule convert_iSNVpytable_To_vcf :
	input:
		iSNVtable="/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/all.iSNV_with_SNP.pyResults.txt",
		ntfreqTable = "/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/out.samps-ntfreq.bigtable.txt",
		RefGnmF = "/shared/liuhj/HP/ref/ref_resistanceGenes/gyrA.fasta"

	output:
		outputP=directory("/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/vcf")
	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
		MinFreq	= 0.05,
		#snv_MaxFreq	= 0.95,
...
rule snpeffAnno:
	input:
		inputvcfP="/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/vcf"
	output:
		outputP=directory("/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/vcf_snpeff")
	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
		dbID="AE004091",
...
rule iSNV_snvNumCount:
	...
	output:
		outputP=directory("/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/snvNum_Stat")
	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
		#iSNV_FreqThres = 0.05,     ## for examp: iSNV_FreqThres = 0.05, mean iSNV freq :>=0.05 && <0.95  ;SNP: >=0.95
		minFreq	= 0.1,
...
rule iSNV_snvNumCount_noSNV:
	input:
		...
		snpEffPath="/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/vcf_snpeff",
	...
	output:
		outputP=directory("/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/snvNum_Stat_noSNV_OtherBacfilted-FiltSimutPARepeat")
	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
		#iSNV_FreqThres = 0.05,     ## for examp: iSNV_FreqThres = 0.05, mean iSNV freq :>=0.05 && <0.95  ;SNP: >=0.95
		minFreq	= 0.1,
...
rule iSNV_SNP_consensusGnm:
	...
	output:
		outputP=directory("/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/subGnm")
	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
		MinFreq	= 0.9,
		#snv_MaxFreq	= 0.95,
...
rule consensusGnm_prokkaAnno:
	input:
		inputP="/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/subGnm"
	output:
		outputP=directory("/shared/liuhj/HP/process/NGS_map2_gyrA/{person}/subGnm_prokka_gff")
	params:
		scriptPath="/shared/liuhj/HP/scripts/HP-microevolution/scripts/iSNV_calling",
