...
if [[ samp != ref_samp ]]; then

#####snpEff
snpEff_P=/shared/liuhj/software/snpEff
snpEff=${snpEff_P}/snpEff.jar
snpEff_config_F=${snpEff_P}/snpEff.config
prokka_out_dir=/shared/liuhj/HP/process/Coregenome-SNP-Loci/prokka_coreGnm/${ref_samp}_CoreGnm_prokka

Anno_vcfP=/shared/liuhj/HP/process/Coregenome-SNP-Loci/vcfAnno_Samp-Core-Gnm--without-P11ONT/${person}
mkdir $Anno_vcfP


vcf_P=/shared/liuhj/HP/process/Coregenome-SNP-Loci/vcf_Samp-Core-Gnm--without-P11ONT/
vcf_F=$vcf_P/${samp}_CoreGnm_Diffposi_map2Respect.vcf

#snpEff config
echo $ref_samp
ref_ID=HPCore_${ref_samp}
hang_1=`echo -e "# HP genome,version  HPCore_${ref_samp}"`
hang_2=`echo -e "HPCore_${ref_samp}.genome : HPCore_${ref_samp}"`
...
databases_gff_P=${snpEff_P}/data/HPCore_${ref_samp}
databases_fna_P=${snpEff_P}/data/genome

mkdir  $databases_gff_P

gff_F=$prokka_out_dir/${ref_samp}_CoreGnm.gff
fna_F=$prokka_out_dir/${ref_samp}_CoreGnm.fna

databases_gff_F=$databases_gff_P/${ref_samp}_CoreGnm.gff
databases_fna_F=$databases_fna_P/${ref_samp}_CoreGnm.fna
...
java -jar  $snpEff   $ref_ID   $vcf_F   >$Anno_vcfP/${samp}_2_${ref_samp}.snpEffAnno.vcf
mv $snpEff_P/snpEff_summary.html  $Anno_vcfP/${samp}.snpEff.summary.html
